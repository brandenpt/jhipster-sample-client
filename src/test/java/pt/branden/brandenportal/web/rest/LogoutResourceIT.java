...
import pt.branden.brandenportal.BrandenPortalApp;
...
import static pt.branden.brandenportal.web.rest.TestUtil.ID_TOKEN;
import static pt.branden.brandenportal.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {BrandenPortalApp.class, TestSecurityConfiguration.class})
